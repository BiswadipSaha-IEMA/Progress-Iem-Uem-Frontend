...
import FacultyConferenceOrganized from "./Components/Faculty/FacultyConferenceOrganized/FacultyConferenceOrganizedComp";
import Lectureseriesorganized from "./Components/Faculty/LectureSeries/Lectureseriescomp";
import Lectureseriescomp from "./Components/Faculty/LectureSeries/Lectureseriescomp";
    ...
    <>
      {userLogin? (
        <Routes>
          ...
          <Route path="/faculty/viewLecture" element={<Lectureseriescomp />} />
