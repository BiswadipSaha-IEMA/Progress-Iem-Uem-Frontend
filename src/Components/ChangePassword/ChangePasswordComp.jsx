    ...
    <div className=" p-4 flex">
      ...
      <div className="w-full h-full">
        ...
        <div className="w-auto absolute top-[10%] text-white pl-[2%]">
          ...
          <h1 className="text-5xl font-bold mb-2">Keep Your Account Secure</h1>
      ...
      <div className="w-[22%] absolute left-[42%] top-[10%]">
        <form className="flex flex-col gap-3">
          ...
          <input className="w-[100%] bg-gray-100 pl-4 p-2 rounded-lg font-400"  type="password" placeholder="Old Password" />
          <input className="w-[100%] bg-gray-100 pl-4 p-2 rounded-lg font-400" type="password" placeholder="New Password" />
          <input className="w-[100%] bg-gray-100 pl-4 p-2 rounded-lg font-400" type="password" placeholder="Confirm New Password"/>

          <button className="bg-[#03A8FD] w-[8rem] m-auto mt-5 py-1 rounded-lg text-white text-lg">Update</button>
