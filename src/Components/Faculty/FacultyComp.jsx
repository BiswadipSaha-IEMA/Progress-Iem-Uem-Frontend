...
import "../StudentComp/customScrollbar.css";
...
function StudentComp() {
  ...
  return (
    <>
      ...
      <div className="relative px-5 sm:px-10 pt-10 pb-10 mt-10 rounded-lg backdrop-blur-lg h-full shadow-[0_0_10px_3px_rgba(3,168,253,0.1)] ml-5 mr-5 sm:ml-10 sm:mr-10 mb-10 md:justify-start md:items-start">
        ...
        <div className="w-full flex mt-5 justify-end gap-3 flex-nowrap overflow-x-auto">
          ...
          {calendarShow && (
           ...
           <div className="border rounded-md border-[#b4b7bd] flex items-center gap-2 px-3 sm:px-4 md:px-5 py-1 flex-shrink-0 text-[#b4b7bd]">
           <button className="text-[0.85rem] sm:text-[0.75rem] md:text-[0.85rem]">
              Add
            </button>
           </div>
        </div>
      ...
      {/* <div className="relative px-5 sm:px-10 pt-10 pb-10 mt-10 rounded-lg backdrop-blur-lg h-[80px] shadow-[0_0_10px_3px_rgba(3,168,253,0.1)] ml-5 mr-5 sm:ml-10 sm:mr-10 mb-10 flex justify-center items-center">
  <button className="text-[15px] sm:text-[20px] font-semibold text-black py-2 px-4 rounded-lg">
    Add Book
  </button>
</div> */}
