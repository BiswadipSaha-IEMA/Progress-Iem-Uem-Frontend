...
export default function FacultyConference() {
  ...
  // Fetching conference data on component mount or showPopUp change
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-1 overflow-auto px-4 sm:px-10">
          ...
          <>
            <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-6 mt-10">
              <div className="flex items-center gap-5 mb-4 sm:mb-0">
                ...
                <div className="text-[20px] sm:text-[25px] font-semibold">Conference</div>
              </div>
        ...
        {showPopUp && <ConferencePopUp setUtilFor="bpAddForm" setShowPopup={setShowPopUp} />}
