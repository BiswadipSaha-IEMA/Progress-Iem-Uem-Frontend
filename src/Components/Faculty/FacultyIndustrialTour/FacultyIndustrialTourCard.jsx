...
function FacultyIndustrialTourCard({
  status,
  title,
  organizedBy,
  date,
  ...
  return (
    <div
      className="w-full md:w-[400px] lg:w-[400px] h-[280px] md:h-[230px] lg:h-[230px] shadow-2xl rounded-2xl flex flex-col items-center p-4 md:p-6 lg:p-8"
    ...
    >
      ...
      <div className="w-full">
        <div className="mb-2 font-medium text-sm md:text-base">
          Organized By:{" "}
          <span className="text-[#999999] font-normal">{organizedBy}</span>
        </div>
        <div className="mb-2 font-medium text-sm md:text-base">
          Date: <span className="text-[#999999] font-normal">{date}</span>
        </div>
        <div className="mb-2 font-medium text-sm md:text-base">
          Industry Name:{" "}
          <span className="text-[#999999] font-normal">{industryName}</span>
        </div>
        <div className="mb-2 font-medium text-sm md:text-base">
          Attended By:{" "}
          <span className="text-[#999999] font-normal">{attendedBy}</span>
        </div>
      </div>
          ...
          <div className="bg-white p-8 rounded-xl w-11/12 max-w-4xl h-[90vh] flex flex-col shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4 text-gray-700">
              ...
              <div>
                ...
                <p className="text-lg">{industryName}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">
                  Attended By:
...
export default FacultyIndustrialTourCard;
