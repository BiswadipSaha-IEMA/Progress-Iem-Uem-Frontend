                ...
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-xl w-11/12 max-w-4xl h-[90vh] flex flex-col shadow-2xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4 text-gray-700">
                            <div>
                                <p className="text-sm font-medium text-gray-500">Name of the Faculty:</p>
                                <p className="text-lg">{faculty}</p>
                            </div>
                            <div>
                                <p className="text-sm font-medium text-gray-500">Date of launching e content:</p>
                                <p className="text-lg">{date}</p>
                            </div>
                            <div>
                                <p className="text-sm font-medium text-gray-500">List of the e-content development facility available:</p>
                                <p className="text-lg">{facilitylist}</p>
                            </div>
                            <div>
                                <p className="text-sm font-medium text-gray-500">Link to the relevant document and facility available in the institution:</p>
                                <p className="text-lg">{faciltylink}</p>
                            </div>
                            <div>
                                <p className="text-sm font-medium text-gray-500">Provide link to videos of the media centre and recording facility:</p>
