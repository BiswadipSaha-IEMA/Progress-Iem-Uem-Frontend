...
export default function FacultyBookPublished() {
  ...
  const columnHeaders = ['Faculty','Name of the module developed', 'Platform on which module is developed ', 'Date of launching e content', 'Link to the relevant document and facility available in the institution','List of the e-content development facility available ' ,'status','Emmil','Proof of Document']
