    ...
    useEffect(() => {
        const getBPData = async () => {
            try {
                ...
                if (response.success) {
                    // Use the response data directly instead of pushing it into an array
                        ...
                        <div className="table-row-group">
                            {currentRows.map((item, rowIndex) => (
                                ...
                                >
                                    ...
                                    <div className="table-cell px-4 py-2 text-[#000]">{item.faculty}</div>
                                    <div className="table-cell px-4 py-2 text-[#000]">{item.developedModule}</div>
                                    <div className="table-cell px-4 py-2 text-[#000]">{item.platformUsed}</div>
                                    <div className="table-cell px-4 py-2 text-[#000]">{item.dateOfLaunch}</div>
                                    <div className="table-cell px-4 py-2 text-[#000]">{item.facility}</div>
                                    <div className="table-cell px-4 py-2 text-[#000]">{item.eFacility}</div>
