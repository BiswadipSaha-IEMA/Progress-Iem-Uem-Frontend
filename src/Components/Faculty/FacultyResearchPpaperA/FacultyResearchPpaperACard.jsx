...
function FacultyResearchPpaperACard({
  status,
  title,
  date,
  name,
  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        ...
        <div className="mb-2 font-medium text-sm md:text-base">
          Publisher Name:{" "}
          <span className="text-[#999999] font-normal">{name}</span>
        </div>
        <div className="mb-2 font-medium text-sm md:text-base">
          ISBN/ISSN No:{" "}
          <span className="text-[#999999] font-normal">{ISBN}</span>
        </div>
      </div>
...
export default FacultyResearchPpaperACard;
