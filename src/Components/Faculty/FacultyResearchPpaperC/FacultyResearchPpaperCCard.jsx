...
function FacultyResearchPpaperCCard({ status, title, date, name, ISBN, driveFileUrl }) {
                ...
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-xl w-11/12 max-w-4xl h-[90vh] flex flex-col shadow-2xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4 text-gray-700">
                            ...
                            <div>
                                <p className="text-sm font-medium text-gray-500">Publisher Name:</p>
...
export default FacultyResearchPpaperCCard;
