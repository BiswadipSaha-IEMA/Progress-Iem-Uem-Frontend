...
export default function FacultyBookPublished() {
            ...
            try {
                ...
                if (response.success) {
                    ...
                    response.data.data.forEach((data) => {
                        if (data.eventType === "Tri-Mentoring")
                            arr.push(data)
                    })
    ...
    const columnHeaders = ['Faculty','Organized By', 'Date', 'Taken By', 'Attended By', 'Status' ,'Proof of Document']
                        ...
                        <div className="table-row-group">
                            {currentRows.map((item, rowIndex) => (
                                ...
                                >
                                    ...
                                    <div className="table-cell px-4 py-2 text-[#000]">{item.takenBy}</div>
