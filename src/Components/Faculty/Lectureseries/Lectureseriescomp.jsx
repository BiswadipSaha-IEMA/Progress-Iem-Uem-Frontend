...
export default function FacultyBookPublished() {
  ...
  const [isLoading, setIsLoading] = useState(true); // Changed to true initially to show loading animation
                  ...
                  <table className="min-w-full">
                    ...
                    <thead>
                      <tr className="bg-[#DEF4FF] h-12 text-center text-[#575757] font-semibold">
                        ...
                        <th className="px-4 py-2 sticky left-0 bg-[#DEF4FF] z-10">Action</th>
                      </tr>
                    </thead>
