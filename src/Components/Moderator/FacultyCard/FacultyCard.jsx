  ...
  return (
    <div className='w-[100%] sm:w-[26rem] p-7 rounded-xl' style={{ boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.3) ' }}>
      ...
      <div className="flex items-center flex-col sm:flex-row gap-6 justify-center mb-2">
        <button className='bg-[#D6FFCE] p-2 text-[#1C6229] flex items-center justify-around w-full sm:w-[45%] rounded-xl text-[19px]'>Accept<TiTick className="text-[30px]" /></button>
        <button className='bg-[#FFDBDB] p-2 text-[#C66666] flex items-center justify-around w-full sm:w-[45%] rounded-xl text-[19px]'>Reject<ImCross className="text-[14px]" /></button>
      </div>
    </div>
  )
}
