...
function ModeratorSignInComp({ email, setEmail, password, setPassword, setHandleLogin, accessToken, setAccessToken }) {
  ...
  return (
    <div className="flex sm:flex-row flex-col sm:ml-0 overflow-hidden h-screen">
      ...
      {/* <div className="w-[100%] sm:w-[50%] 2xl:w-[40%] relative mt-4 md:ml-[2vw] lg:[5vw] 2xl:ml-[-2rem] "> */}
        ...
        <h2 className="font-semibold lg:text-[2.4rem] text-[1.5rem] text-[#03A8FD] font-poppins">{" "}Moderator</h2>
          </div>
...
export default ModeratorSignInComp;
