    ...
    >
      <RxCross2 className="text-white" />
        ...
        <div className='w-full flex flex-col justify-center md:justify-end md:mr-24 mt-8 md:flex-row'>
            ...
            <div className='w-[90%] ml-5 md:w-[230px] flex align-middle items-center justify-center text-[20px] text-white bg-[#03a8fd] rounded-[16px] hover:bg-blue-600 cursor-pointer'>
              Set Date
            </div>
        </div>  
